...
class Centro(models.Model):
    centro_telecomunicaciones=models.ForeignKey(Centro_Telecomunicaciones, on_delete=models.CASCADE)
    nombre = models.CharField(max_length=60)
...
class OrdenPrimaria(models.Model):
    ...
    mano_obra=models.ForeignKey(ManoObra, on_delete=models.CASCADE, blank=True, null=True)
    ...
    llama=models.ForeignKey(Trabajador, on_delete=models.CASCADE, blank=True, null=True)
